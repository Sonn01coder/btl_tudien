...
public class ContentController implements Initializable {
    ...
    public void init(Word word, HelloController helloController) {
        ...
        pronounceText.setText(word.getWordForm());
    ...
    public void onEditWord(ActionEvent actionEvent) {
        try {
            ...
            UpdateWordController createWordController = fxmlLoader.getController();
            createWordController.init(new Word(wordText.getText(), explainText.getText(), pronounceText.getText(), spellingText.getText(), exampleText.getText()), this.dictionaryManagement);
